...
export default function Success({ customerName, productsImages }: SuccessProps) {
  const quantity = productsImages.length
  ...
  return (
    <>
      ...
      <SuccessContainer>
        ...
        <p>
          Uhuul <strong>{customerName}</strong>, sua compra de {quantity} {quantity === 1 ? 'camiseta' : 'camisetas'} já está a caminho da sua casa.
        </p>
