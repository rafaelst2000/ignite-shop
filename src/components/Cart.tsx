...
import { CartClose, CartContent, CartFinalization, CartProduct, CartProductDetails, CartProductImage } from '@/styles/components/cart'
      ...
      <Dialog.Portal>
        <CartContent>
            ...
            <section>
              ...
              {cartQuantity >= 1 && cartItems.map((cartItem) => (
            ...
            <CartFinalization>
              ...
              <button onClick={handleCheckout} disabled={isCreatingCheckoutSession || cartQuantity <=0}>
                {isCreatingCheckoutSession ? 'Redirecionando para o pagamento...' : 'Finalizar compra'}
              </button>
            </CartFinalization>
        </CartContent>
      </Dialog.Portal>
